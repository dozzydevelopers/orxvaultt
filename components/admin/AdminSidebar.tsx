...
const AdminSidebar: React.FC<AdminSidebarProps> = ({ currentPath, navItems }) => {
    ...
    return (
        <aside className="hidden md:flex flex-col w-64 bg-[var(--background-secondary)] p-4 border-r border-[var(--border-color)]">
            ...
            <p className="px-4 text-sm font-semibold text-[var(--accent-text)] uppercase tracking-wider">Admin Panel</p>
